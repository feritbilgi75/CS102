...
public class OneBot extends Robot {
    ...
    public OneBot(boolean isRedTeam){
        ...
        health = random.nextDouble(0.5,1);
        attack = random.nextDouble(4,5);
    ...
    public void attack(Simulation s) {
        ...
        if (isRedTeam == true){
            ...
            int index = s.blueTeam.indexOf(s.getLowestHealth(!isRedTeam));
            boolean isDead = s.getLowestHealth(!isRedTeam).getHitAndIsDestroyed(attack);
            ...
            int index = s.redTeam.indexOf(s.getLowestHealth(!isRedTeam));
            boolean isDead = s.getLowestHealth(!isRedTeam).getHitAndIsDestroyed(attack);
